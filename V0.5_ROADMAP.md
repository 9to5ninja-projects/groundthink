...
**Status:** Phase 0 (Base Model Characterization) → Phase 1 (Implementation)
**Governance:** Librarian Tier 1 (Task Tracking) + Documentation-First Strategy

**⚠️ PREREQUISITE:** [BASE_MODEL_CHARACTERIZATION.md](BASE_MODEL_CHARACTERIZATION.md) — Benchmark pure RWKV-6 and Mamba-2 before fusion design.
...
- 0.0.1: Pure RWKV-6 benchmark (4M)
- 0.0.2: Pure Mamba-2 benchmark (4M)
- 0.0.3: GPT-1 baseline (4M)
- 0.0.4: Comparative analysis
- 0.0.5: Scale test (8M, optional)

**Gate:** Phase 0 complete → Findings inform Phase 1 fusion design.
...
| 0.5 | **Segment Embeddings** | 🟡 HIGH | ⬜ TODO | M | Explicit tokens/embeddings for thought blocks. |
| 0.6 | **Three-Phase Fade** | 🟢 LOW | ⬜ TODO | L | Importance weighting schedule and loss scaling. |
